""
" Name:        alabaster-darker-saturated.vim
" Description: Simple recolor fork of sderev's dark theme Alabaster variant with less
"              muted, more saturated colors, based on personal preference of
"              higher contrast colors. (sderev's theme is originally based on
"              tonsky's Alabaster theme.)
" Maintainer:  reintse
" License:     MIT
"""
...
" COLOR PALETTE
" ============================================================================
" PLEASE NOTE, I, REINTSE, ONLY MODIFIED THE COLOR PALETTE! OTHER PARTS OF THE
" THEME REMAIN UNCHANGED. I TAKE NO CREDIT FOR THE REST OF THE THEME'S CODE.
" Base backgrounds
let s:bg_main        = '#0e0f14'   " cterm: 233 - Very dark, nearly black shade of blue
let s:bg_highlight   = '#161220'   " cterm: 234 - Subtle highlight, slightly lighter shade of blue
let s:bg_dark        = '#231d33'   " cterm: 236 - Dark grey-green (selection)

" Foreground colors
let s:fg_main        = '#ebdabc'   " cterm: 252 - Creamy off-white (main text)
let s:fg_grey        = '#808b8d'   " cterm: 66  - Light-grey (punctuation)
let s:fg_grey_dim    = '#696969'   " cterm: 239 - Dim, brownish grey (less important)

" Semantic colors (muted for dark background)
let s:gold           = '#c67c17'   " cterm: 179 - Goldish orange (cursor, highlights)
let s:yellow_beige   = '#ceb404'   " cterm: 186 - Condiment yellow (comments)
let s:green_muted    = '#467a47'   " cterm: 114 - Leaf green (strings)
let s:pink_muted     = '#ac67ac'   " cterm: 182 - Muted pink/magenta (constants)
let s:blue_light     = '#41abcd'   " cterm: 110 - Light teal (definitions, functions)
let s:blue_bright    = '#007dff'   " cterm: 45  - Deep blue (links, special)
